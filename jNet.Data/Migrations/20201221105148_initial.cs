        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyDetails_Customer_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyDetails_Supplier_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Businesses_CompanyDetails_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "Id", "AccountNumber", "Description", "Direction", "IsSummaryAccount", "Name", "ParentId", "Type" },
                values: new object[] { -1L, null, "The root account", 0, false, "", -1L, "0" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyDetails_CustomerId",
                table: "CompanyDetails",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyDetails_SupplierId",
                table: "CompanyDetails",
                column: "SupplierId");
